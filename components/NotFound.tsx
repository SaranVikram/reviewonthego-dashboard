  ...
  return (
    <div className="rounded-sm border border-stroke bg-white px-5 py-10 shadow-default dark:border-strokedark dark:bg-boxdark sm:py-20">
      <div className="mx-auto max-w-[410px]">
        <Image alt="illustration" loading="lazy" width={400} height={400} decoding="async" data-nimg="1" src="/images/illustrations/Asset-1.png" style={{ color: "transparent" }} />
        <div className="mt-7.5 text-center">
          <h2 className="mb-3 text-2xl font-bold text-black dark:text-white">Coming Soon</h2>
          <p className="font-medium">We&apos;re working hard to bring you the best experience. Stay tuned!</p>
